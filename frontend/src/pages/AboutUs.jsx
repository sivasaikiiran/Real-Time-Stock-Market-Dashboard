  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      ...
      <section className="flex flex-col items-center mb-10">
        ...
        />
        <h2 className="text-2xl font-semibold text-gray-700">Kiran</h2>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-600 leading-7 mt-2">
          <strong>Email:</strong> <a href="mailto:msskiran2020@gmail.com" className="text-teal-500">msskiran2020@gmail.con</a>
        </p>
        <p className="text-gray-600 leading-7">
          <strong>Phone:</strong> +91 9177797542
        </p>
        <div className="flex space-x-4 mt-4">
          <a href="https://github.com/sivasaikiiran" className="text-teal-500 hover:underline">GitHub</a>
          <a href="https://www.linkedin.com/public-profile/settings" className="text-teal-500 hover:underline">LinkedIn</a>
        </div>
      </section>
    </div>
  );
